                                ...
                                getStackCount: function() {
                                    ...
                                    return (
                                        e.each(
                                            ...
                                            function(e, a) {
                                                var o = t.chart.getDatasetMeta(
                                                    a
                                                );
                                                o.bar &&
                                                    t.chart.isDatasetVisible(
                                                        a
                                                    ) &&
                                                    (i.options.stacked === !1 ||
                                                        (i.options.stacked ===
                                        ...
                                        if (
                                            ...
                                            for (
                                                ...
                                                var d =
                                                    ...
                                                    c = a.chart.getDatasetMeta(
                                                        u
                                                    );
                                                if (
                                                    c.bar &&
                                                    c.xAxisID === n.id &&
                                                    a.chart.isDatasetVisible(
                                                        u
                                                    ) &&
                                                    i.stack === c.stack
                                                ) {
                                ...
                                callbacks: {
                                    ...
                                    label: function(t, a) {
                                        var i = a.labels[t.index],
                                            n =
                                                ": " +
                                                a.datasets[t.datasetIndex].data[
                                                    t.index
                                                ];
                                        return (
                                            e.isArray(i)
                            ...
                            (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
                                {
                                    ...
                                    update: function(t) {
                                        ...
                                        (i.borderWidth = a.getMaxBorderWidth(
                                            c.data
                                        )),
                            ...
                            (t.controllers.radar = t.DatasetController.extend({
                                ...
                                updateBezierControlPoints: function() {
                                    ...
                                    e.each(a.data, function(i, n) {
                                        var o = i._model,
                                            r = e.splineCurve(
                                                e.previousItem(a.data, n, !0)
                                                    ._model,
                                                o,
                                                e.nextItem(a.data, n, !0)
                                                    ._model,
                                                o.tension
                                            );
                        ...
                        (t.defaults.global.animation = {
                            ...
                            (t.animationService = {
                                ...
                                addAnimation: function(t, e, a, i) {
                                    ...
                                    for (
                                        var o = 0;
                                        o < n.animations.length;
                                        ++o
                                    )
                                        if (n.animations[o].chartInstance === t)
                                            return void (n.animations[
                                                o
                                            ].animationObject = e);
                                    n.animations.push({
                                        chartInstance: t,
                        ...
                        (t.types = {}),
                            ...
                            i.extend(t.Controller.prototype, {
                                        ...
                                        (i.each(
                                            ...
                                            function(i, o) {
                                                ...
                                                r.type ||
                                                    ...
                                                    a.push(r.type),
                                                    r.controller
                                                        ? r.controller.updateIndex(
                                                              o
                                                          )
                                                        : ((r.controller = new t.controllers[
                                                              r.type
                                                          ](e, o)),
                                                          n.push(r.controller));
                                            },
                                ...
                                updateDatasets: function() {
                                    var t = this;
                                    if (
                                        n.notify(t, "beforeDatasetsUpdate") !==
                                        !1
                                    ) {
                                        for (
                                            var e = 0,
                                ...
                                drawDatasets: function(t) {
                                    var e = this;
                                    n.notify(e, "beforeDatasetsDraw", [t]) !==
                                        !1 &&
                                        (i.each(
                                            e.data.datasets,
                                            function(a, i) {
                    ...
                    e.exports = function(t) {
                        ...
                        t.layoutService = {
                            ...
                            removeBox: function(t, e) {
                                t.boxes &&
                                    t.boxes.splice(t.boxes.indexOf(e), 1);
                            },
                            update: function(t, a, i) {
                                ...
                                if (t) {
                                    ...
                                    var g = e.where(t.boxes, function(t) {
                                            return (
                                                "left" === t.options.position
                                            );
                                        }),
                                        p = e.where(t.boxes, function(t) {
                                            return (
                                                "right" === t.options.position
                                            );
                                        }),
                                    ...
                                    if (
                                        ...
                                        if (((s.font = f), m)) {
                                            var v = (a.lineWidths = [0]),
                                                b = a.legendItems.length
                                                    ? d + o.padding
                                                    : 0;
                                            (s.textAlign = "left"),
                                                (s.textBaseline = "top"),
                                                i.each(a.legendItems, function(
                                                    t,
                                                    i
                                                ) {
                                                    var n = e(o, d),
                        ...
                        (t.defaults.scale = {
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                beforeUpdate: function() {
                                    i.callCallback(this.options.beforeUpdate, [
                                        this
                                    ]);
                                },
                                update: function(t, e, a) {
                                ...
                                afterUpdate: function() {
                                    i.callCallback(this.options.afterUpdate, [
                                        this
                                    ]);
                                },
                                ...
                                afterDataLimits: function() {
                                    i.callCallback(
                                        this.options.afterDataLimits,
                                        [this]
                                    );
                                },
                                beforeBuildTicks: function() {
                                    i.callCallback(
                                        this.options.beforeBuildTicks,
                                        [this]
                                    );
                                },
                                buildTicks: i.noop,
                                ...
                                beforeFit: function() {
                                    i.callCallback(this.options.beforeFit, [
                                        this
                                    ]);
                                },
                                fit: function() {
                                ...
                                afterFit: function() {
                                    i.callCallback(this.options.afterFit, [
                                        this
                                    ]);
                                },
                                isHorizontal: function() {
                        ...
                        t.Ticks = {
                            generators: {
                                ...
                                logarithmic: function(t, a) {
                                    ...
                                    0 === s
                                        ? ((i = Math.floor(
                                              e.log10(a.minNotZero)
                                          )),
                                          (n = Math.floor(
                                              a.minNotZero / Math.pow(10, i)
                                          )),
                                          o.push(s),
                                          (s = n * Math.pow(10, i)))
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                update: function(e) {
                                    ...
                                    if (g.length) {
                                        f.opacity = 1;
                                        var k = [];
                                        y = t.Tooltip.positioners[c.position](
                                            g,
                                            d._eventPosition
                                        );
                                        var S = [];
                                        ...
                                        c.filter &&
                                            ...
                                            (f.x = Math.round(y.x)),
                                            (f.y = Math.round(y.y)),
                                            (f.caretPadding = l.getValueOrDefault(
                                                y.padding,
                                                2
                                            )),
                                            (f.labelColors = k),
                    ...
                    e.exports = function(t) {
                        ...
                        function a(t, a) {
                            ...
                            if (null === n || "" === n)
                                if ("" === t.style.height)
                                    t.height =
                                        t.width / (a.options.aspectRatio || 2);
                                else {
                                    var s = e(t, "height");
                                    void 0 !== r && (t.height = s);
                                }
                        ...
                        return {
                            ...
                            addEventListener: function(t, e, a) {
                                ...
                                if ("resize" === e)
                                    return void r(i.parentNode, a, t.chart);
                        ...
                        t.LinearScaleBase = t.Scale.extend({
                            ...
                            buildTicks: function() {
                                ...
                                var r = {
                                    ...
                                    s = (a.ticks = t.Ticks.generators.linear(
                                        r,
                                        a
                                    ));
                            ...
                            i = t.Scale.extend({
                                ...
                                buildTicks: function() {
                                    var a = this,
                                        ...
                                        r = (a.ticks = t.Ticks.generators.logarithmic(
                                            o,
                                            a
                                        ));
                        ...
                        var f = t.helpers,
                            ...
                            m = t.LinearScaleBase.extend({
                                ...
                                setCenterPoint: function(t, e, a, i) {
                                    ...
                                    (n.xCenter = Math.round(
                                        (r + o) / 2 + n.left
                                    )),
                                        (n.yCenter = Math.round(
                                            (s + l) / 2 + n.top
                                        ));
                                },
                                ...
                                o = t.Scale.extend({
                                    ...
                                    determineDataLimits: function() {
                                        ...
                                        t.chart.data.labels.length > 0
                                            ...
                                            t.options.time.min &&
                                                (t.firstTick = t.parseTime(
                                                    t.options.time.min
                                                )),
                                            t.options.time.max &&
                                                (t.lastTick = t.parseTime(
                                                    t.options.time.max
                                                )),
                                            (t.firstTick = (
                                                t.firstTick || i()
                                    ...
                                    buildTicks: function() {
                                        ...
                                        if (
                                            ...
                                            (i.tickUnit =
                                                i.options.time.unit || "day"),
                                                (i.displayFormat =
                                                    i.options.time.displayFormats[
                                                        i.tickUnit
                                                    ]),
                                        ...
                                        if (
                                            (i.options.time.min
                                                ? (x = i.getMomentStartOf(
                                                      i.firstTick
                                                  ))
                                                : ((i.firstTick = i.getMomentStartOf(
                                                      i.firstTick
                                                  )),
                                                  (x = i.firstTick)),
                                            !i.options.time.max)
                                        ) {
                                            var y = i.getMomentStartOf(
                                                    i.lastTick
                                                ),
                                                k = y.diff(
                                                    i.lastTick,
                                    ...
                                    getLabelForIndex: function(t, e) {
                                        var a = this,
                                            i =
                                                a.chart.data.labels &&
                                                t < a.chart.data.labels.length
                                                    ? a.chart.data.labels[t]
                                                    : "",
                                            n =
                                                a.chart.data.datasets[e].data[
                                                    t
                                                ];
                                        return (
                                            null !== n &&
