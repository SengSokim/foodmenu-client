...
/***/ "./resources/assets/js/customers/edit.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/customers/edit.js ***!
  \***********************************************/
...
app = new Vue({
  ...
  methods: {
    save: function save() {
      axios.post("/admin/customers/update/".concat(this.data.id), {
        name: this.data.name,
        ...
        if (response.data.success) {
          window.location.href = "/admin/customers/view/".concat(data.id);
        } else {
        ...
        hideLoading();
        showAlertError('Cannot edit customer!');
        console.log(error);
      });
    },
...
/***/ 14:
/*!*****************************************************!*\
  !*** multi ./resources/assets/js/customers/edit.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\NU lessons\Year IV School Lessons\Theses\project\admin\resources\assets\js\customers\edit.js */"./resources/assets/js/customers/edit.js");
