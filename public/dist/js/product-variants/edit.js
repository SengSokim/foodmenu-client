...
/***/ "./resources/js/product-variants/edit.js":
/*!***********************************************!*\
  !*** ./resources/js/product-variants/edit.js ***!
  \***********************************************/
...
var EditProductVariant = new Vue({
  ...
  methods: {
    ...
    save: function save() {
      ...
      axios.post("".concat(baseURL, "/admin/product-variants/").concat(data.id), this.data).then(function (response) {
        if (response.data.success) {
          window.location.href = baseURL + '/admin/product-variants?product_id=' + _this.data.product_id;
        } else {
  ...
  mounted: function mounted() {
    this.data.values.forEach(function (value) {
...
/***/ 3:
/*!*****************************************************!*\
  !*** multi ./resources/js/product-variants/edit.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\papadeliver\emenu\portal\resources\js\product-variants\edit.js */"./resources/js/product-variants/edit.js");
