...
editProfile = new Vue({
  ...
  methods: {
    ...
    viewProfile: function viewProfile() {
      ...
      axios.get("/admin/profile").then(function (response) {
        if (response.data.success) {
...
updatePassword = new Vue({
  ...
  methods: {
    save: function save() {
      axios.post("/admin/profile/change_password", this.data).then(function (response) {
        if (response.data.success) {
          window.location.href = '/admin/products';
        } else {
          showAlertError(response.data.message);
...
module.exports = __webpack_require__(/*! C:\Users\Sengs\OneDrive\Desktop\laravelvid\laravel-foodmenu\admin\resources\assets\js\profile.js */"./resources/assets/js/profile.js");
