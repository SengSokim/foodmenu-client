...
/***/ "./resources/assets/js/quotations/create.js":
/*!**************************************************!*\
  !*** ./resources/assets/js/quotations/create.js ***!
  \**************************************************/
...
var _contact$sale_id, _contact$name, _contact$phone_number, _contact$address;
app = new Vue({
  el: "#createQuotation",
  data: {
    sales: sales,
    data: {
      sale_id: (_contact$sale_id = contact.sale_id) !== null && _contact$sale_id !== void 0 ? _contact$sale_id : null,
      name: (_contact$name = contact.name) !== null && _contact$name !== void 0 ? _contact$name : '',
      phone: (_contact$phone_number = contact.phone_number) !== null && _contact$phone_number !== void 0 ? _contact$phone_number : '',
      price: 120,
      campus_amount: 1,
      discount: null,
      quotation_date: date,
      address_en: (_contact$address = contact.address) !== null && _contact$address !== void 0 ? _contact$address : '',
      address_kh: '',
      descript: '',
      seller: '',
      customer: '',
      status: 'opened',
      is_show_money_no_vat_on_print: true,
      exchange_rate: '',
      term_condition: ''
    },
    is_lock: false,
  ...
  methods: {
    ...
    save: function save() {
      var _this2 = this;
      axios.post('/admin/quotations/store', this.data).then(function (res) {
        if (res.data.success) {
        ...
        hideLoading();
        showAlertError('Can not add quotation');
        console.log(error);
      });
    },
...
/***/ 23:
/*!********************************************************!*\
  !*** multi ./resources/assets/js/quotations/create.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\NU lessons\Year IV School Lessons\Theses\project\admin\resources\assets\js\quotations\create.js */"./resources/assets/js/quotations/create.js");
