...
EditRestaurant = new Vue({
  ...
  methods: {
    save: function save() {
      axios.post("/admin/restaurants", this.data).then(function (response) {
...
module.exports = __webpack_require__(/*! C:\Users\Sengs\OneDrive\Desktop\laravelvid\laravel-foodmenu\admin\resources\assets\js\restaurants\edit.js */"./resources/assets/js/restaurants/edit.js");
