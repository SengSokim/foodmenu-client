...
/***/ "./resources/assets/js/sales/view.js":
/*!*******************************************!*\
  !*** ./resources/assets/js/sales/view.js ***!
  \*******************************************/
/*! no static exports found */
...
app = new Vue({
  ...
  data: {
    ...
    is_update_sale_note: false,
    is_update_sale_document: false,
  ...
  methods: {
    ...
    hideModalDocument: function hideModalDocument() {
      ...
      this.hideFormSaleDocument();
      $('#modal_sale_document').modal('hide');
    },
    pushTypeValue: function pushTypeValue(item) {
      $('#typ_value').val(item);
      this.document.type = item;
    },
    uploadSaleDocument: function uploadSaleDocument(event) {
      var _this = this;
    ...
    // Hide form create document for sale
    hideFormSaleDocument: function hideFormSaleDocument() {
      this.document = {
        id: null,
        name: '',
        type: '',
    ...
    // save document
    createSaleDocument: function createSaleDocument() {
      var _this2 = this;
      axios.post("/admin/sales/documents/store/".concat(this.data.id), this.document).then(function (response) {
        if (response.data.success) {
          hideLoading();
          _this2.is_show_form_document = false;
          _this2.hideFormSaleDocument();
    ...
    submitSaleDocument: function submitSaleDocument() {
      var _this3 = this;
      showLoading();
      this.$validator.validate().then(function (result) {
        ...
        if (!result) {
          ...
          _this3.createSaleDocument();
        }
      });
    },
    // Show document
    showSaleDocument: function showSaleDocument(item) {
      this.is_update_sale_document = true;
      this.document = Object.assign({}, item);
      $("#file_name").val(item.name + '.' + item.ext);
      this.is_show_form_document = true;
    },
    // Update document
    updateSaleDocument: function updateSaleDocument() {
      var _this4 = this;
      showLoading();
      axios.post("/admin/sales/documents/update/".concat(this.data.id), this.document).then(function (response) {
        if (response.data.success) {
          hideLoading();
    ...
    selectDocumentIndex: function selectDocumentIndex(id) {
      this.document.id = id;
      $('#modal_delete_sale_document').modal('show');
    },
    deleteSaleDocument: function deleteSaleDocument() {
      var _this5 = this;
      showLoading();
      axios.post("/admin/sales/documents/delete/".concat(this.document.id), {
        id: this.document.id
        ...
        if (response.data.success) {
          ...
          $('#modal_delete_sale_document').modal('hide');
    ...
    // Note
    hideModalSaleNote: function hideModalSaleNote() {
      this.sale.note = "";
      this.is_show_invalid = false;
      $("#modal_sale_note").modal('hide');
    },
    hideModelFormSaleNote: function hideModelFormSaleNote() {
      this.sale.note = '';
      this.is_show_invalid = false;
      this.is_show_form_note = false;
    },
    showModalCreateSaleNote: function showModalCreateSaleNote() {
      this.is_update_sale_note = false;
      this.is_show_form_note = true;
    },
    // save note
    saveSaleNote: function saveSaleNote() {
      var _this6 = this;
      showLoading();
      axios.post("/admin/sales/notes/store/".concat(this.data.id), {
        note: this.sale.note
      }).then(function (response) {
        if (response.data.success) {
          hideLoading();
    ...
    submitSaleNote: function submitSaleNote() {
      var _this7 = this;
      this.$validator.validate().then(function (result) {
        result = !_this7.sale.note ? false : true;
        if (!result) {
          hideLoading();
...
/***/ 10:
/*!*************************************************!*\
  !*** multi ./resources/assets/js/sales/view.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\NU lessons\Year IV School Lessons\Theses\project\admin\resources\assets\js\sales\view.js */"./resources/assets/js/sales/view.js");
