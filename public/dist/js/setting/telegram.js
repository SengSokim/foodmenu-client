  ...
  mounted: function mounted() {
    ...
    axios.get("/portal/restaurants").then(function (response) {
      if (response.data.success) {
        ...
        _this.data.name = _this.telegramData.name;
        _this.data.telegram_user = _this.telegramData.telegram_user;
        _this.data.telegram_group = _this.telegramData.telegram_group;
        hideLoading();
      } else {
