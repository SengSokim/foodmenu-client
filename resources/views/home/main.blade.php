    ...
    <body data-spy="scroll" data-target="#scrollspy" >
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.html">
                    <img src="images/emenu-secondary-transparent.png" alt="" style="width: 150px;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto" id="scrollspy">
        ...
        <footer class="ftco-footer ftco-no-pt">
            ...
            <div class="col-md-12 text-center">
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Papa deliver</a>
