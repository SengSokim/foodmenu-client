                ...
                <div class="modal-footer">
                    ...
                    <div style="display: flex;">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"
                            style="background-color: #154d97;" :disabled="carts.length == 0"><i
                                class="fas fa-check mr-1"></i>Checkout</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="myModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="color: #154d97;" class="modal-title text-bold">
                ...
                <form @submit.prevent="submit" v-cloak id="customer_info">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            :class="{'is-invalid': errors.has('customer_name') }" v-validate="'required'"
                            id="customer-name" v-model="orderDetails.customer_name" name="customer_name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            :class="{'is-invalid': errors.has('customer_phone') }" v-validate="'required'"
                            id="customer-phone" v-model="orderDetails.phone_number" name="customer_phone">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="customer-address" v-model="orderDetails.address"
                            :class="{'is-invalid': errors.has('customer_address') }" v-validate="'required'"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #154d97;"
                            id="submitBtn">
    ...
    <div class="modal fade" id="invoiceModal" tabindex="-1" role="dialog" aria-labelledby="invoiceModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-borderless">
                            <thead>
                                <tr>
                                    <th style="color: #154d97;"><i
                                            class="fas fa-utensils mr-1 display-icon"></i>Name</th>
                                    <th style="color: #154d97;"><i
                                            class="fas fa-dollar-sign mr-1 display-icon"></i>Price</th>
                                    <th style="color: #154d97;"><i
                                            class="fas fa-sort-numeric-up mr-1 display-icon"></i>Quantity</th>
                                    <th style="color: #154d97;"><i
                                            class="fas fa-dollar-sign mr-1 display-icon"></i>Sub Total</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="text-left" style="display: flex; justify-content: space-between;">
                        <div>
                            <h5>
                                <strong><i class="fas fa-user mr-1 display-icon"></i>Name:</strong>
                                <span>@{{ orderDetails.customer_name }}</span>
                            </h5>
                            <hr>
                            <h5>
                                <strong><i class="fas fa-phone mr-1 display-icon"></i>Phone:</strong>
                                <span>@{{ orderDetails.phone_number }}</span>
                            </h5>
                            <hr>
                            <h5>
                                <strong><i class="fas fa-address-card mr-1 display-icon"></i>Address:</strong>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal" id="btn-close-invoice"><i
