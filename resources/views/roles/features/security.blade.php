<div class="row">
    <div class="col-md-12">
        <div class="row mx-2 mt-3">
            <h5><i class="fas fa-cog"></i><label class="px-1">Security</label></h5>
        </div>
        <div class="row">
            <div class="col-md-3">
                <div class="card">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header bg-light">
                        <label class="m-0"><i class="fas fa-bookmark"></i> Role</label>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-2">
                                    <div class="checkbox">
                                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                            <input type="checkbox" class="custom-control-input" id="roles-read" value="roles-read" v-model="data.data">
                                            <label class="custom-control-label" for="roles-read">Read</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group my-2">
                                    <div class="checkbox">
                                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                            <input type="checkbox" class="custom-control-input" id="roles-create" value="roles-create" v-model="data.data">
                                            <label class="custom-control-label" for="roles-create">Create</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group my-2">
                                    <div class="checkbox">
                                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                            <input type="checkbox" class="custom-control-input" id="roles-update" value="roles-update" v-model="data.data">
                                            <label class="custom-control-label" for="roles-update">Update</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group my-2">
                                    <div class="checkbox">
                                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                            <input type="checkbox" class="custom-control-input" id="roles-deletex" value="roles-deletex" v-model="data.data">
                                            <label class="custom-control-label" for="roles-deletex">Delete</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
