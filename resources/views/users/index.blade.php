            ...
            <div class="card-header">
                <div class="row d-flex justify-content-between"> 
                    ...
                    <div class="card-tools mt-1" style="float:right">
                        <button @click="clearData()" class="btn btn-warning btn-sm rounded-pill"  title="Create" data-toggle="modal" data-target="#createUser"><i class="far fa-plus fa-fw"></i>{{ __('app.global.create-new') }}</button>
